 ...
 * coordinates generated by this class using the hexCenters array property. mexHexID and layers may be useful as well
...
export class HexGrid {
    ...
    constructor( layers, scale = 1 ) {
        ...
        this.mexHexID = 3 * (layers + 1) * layers;
    ...
    neighborsOf( hexID ){
        ...
        if (upLeftNeighborId <= this.mexHexID){
            neighbors.push(upLeftNeighborId);
        }
        if (upRightNeighborId <= this.mexHexID){
            neighbors.push(upRightNeighborId);
        }
        if (rightNeighborId <= this.mexHexID){
            neighbors.push(rightNeighborId);
        }
        if (downRightNeighborId <= this.mexHexID){
            neighbors.push(downRightNeighborId);
        }
        if (downLeftNeighborId <= this.mexHexID){
            neighbors.push(downLeftNeighborId);
        }
        if (leftNeighborId <= this.mexHexID){
